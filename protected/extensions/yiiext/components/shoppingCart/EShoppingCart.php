...
class EShoppingCart extends CMap {
    ...
    public function restoreFromSession() {
        ...
        $this->sucursal = Yii::app()->getUser()->getState('suc' . $this->cartId);
    ...
    public function setSucursal($value) {
        $this->sucursal = $value;
        Yii::app()->getUser()->setState('suc' . $this->cartId, $this->sucursal);
    }
    ...
    public function clean() {
        Yii::app()->user->setState('suc' . $this->cartId,null);
    }
    ...
    public function getCost($withDiscount = true) {
        ...
        foreach ($this as $position)
        {
            $price += $position->getSumPrice($withDiscount) + $position->extra;
        }
