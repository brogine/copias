 ...
 * @property Documentocurso $idCurso0
 */
class Curso extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idCurso, sDescripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'idCurso0' => array(self::BELONGS_TO, 'Documentocurso', 'idCurso'),
		);
	}
