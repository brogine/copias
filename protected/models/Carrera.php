 ...
 * @property Documentocarrera $idCarrera0
 */
class Carrera extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idCarrera, sDescripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'idCarrera0' => array(self::BELONGS_TO, 'Documentocarrera', 'idCarrera'),
		);
	}
