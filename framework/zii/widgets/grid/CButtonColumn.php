...
class CButtonColumn extends CGridColumn
{
	 ...
	 */
	public $viewButtonUrl='Yii::app()->controller->createUrl("ver",array("id"=>$data->primaryKey))';
	/**
	 ...
	 * please refer to the {@link http://www.php.net/manual/en/language.expressions.php php manual}.
	 */
	public $updateButtonUrl='Yii::app()->controller->createUrl("editar",array("id"=>$data->primaryKey))';
	/**
	 ...
	 * please refer to the {@link http://www.php.net/manual/en/language.expressions.php php manual}.
	 */
	public $deleteButtonUrl='Yii::app()->controller->createUrl("eliminar",array("id"=>$data->primaryKey))';
	/**
